...
if (!dojo._hasResource["zstaff.widget.SelectContainer"]) {
	...
	dojo.declare("zstaff.widget.SelectContainer", [dijit._Widget, dijit._Templated], {templateString:"<div dojoAttachPoint=\"table_options\" class='widget_selectcontainer' >\n\t<div dojoAttachPoint=\"body_options\" class='inside'>\n\t</div>\n</div>\t\n", table_options:null, body_options:null, name:"", icon:"", store:null, values:{}, _valuesadded:{}, _constructor:function () {
		this._valuesadded = {};
		...
		var load = function (item) {
			...
			if (slf.store.isItemLoaded(item)) {
				...
				slf.store.loadItem({item:item, onItem:function (result, dataObject) {
					show(dataObject);
				}});
			}
		};
