...
if (!dojo._hasResource["zstaff.widget.Calendar"]) {
	dojo._hasResource["zstaff.widget.Calendar"] = true;
	dojo.provide("zstaff.widget.Calendar");
	dojo.require("dijit.form._FormWidget");
	dojo.require("dijit._Calendar");
	dojo.require("dijit.form.TimeTextBox");
	dojo.declare("zstaff.widget.Calendar", [dijit.form._FormWidget], {name:"", boxInput:null, divCalendar:null, ctlCalendar:null, value:new Date(), templateString:"<div class='calendar'>\n\t<input dojoAttachPoint='boxInput,focusNode' type='hidden' value='' name='${name}'>\n\t<div dojoAttachPoint='divCalendar'>\n\t\t\n\t</div>\n</div>\n", form:null, onChange:function (e) {
	}, postCreate:function () {
