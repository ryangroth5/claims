...
if (!dojo._hasResource["dojox.gfx3d.matrix"]) {
	...
	dojo.mixin(dojox.gfx3d.matrix, {identity:new dojox.gfx3d.matrix.Matrix3D(), translate:function (a, b, c) {
		...
		return dojox.gfx3d.matrix.rotateX(dojox.gfx3d.matrix._degToRad(degree));
	}, rotateY:function (angle) {
		var c = Math.cos(angle);
		var s = Math.sin(angle);
		return new dojox.gfx3d.matrix.Matrix3D({xx:c, xz:s, zx:-s, zz:c});
	}, rotateYg:function (degree) {
		return dojox.gfx3d.matrix.rotateY(dojox.gfx3d.matrix._degToRad(degree));
	}, rotateZ:function (angle) {
		var c = Math.cos(angle);
		var s = Math.sin(angle);
		return new dojox.gfx3d.matrix.Matrix3D({xx:c, xy:-s, yx:s, yy:c});
	}, rotateZg:function (degree) {
		return dojox.gfx3d.matrix.rotateZ(dojox.gfx3d.matrix._degToRad(degree));
		...
		return (matrix instanceof dojox.gfx3d.matrix.Matrix3D) ? matrix : new dojox.gfx3d.matrix.Matrix3D(matrix);
