...
if (!dojo._hasResource["dojox.atom.io.model"]) {
	...
	dojox.atom.io.model._actions = {"link":function (obj, node) {
		if (obj.links === null) {
			obj.links = [];
		}
	...
	dojox.atom.io.model.util = {createDate:function (node) {
	...
	dojo.declare("dojox.atom.io.model.Node", null, {constructor:function (name_space, name, attributes, content, shortNs) {
	...
	dojo.declare("dojox.atom.io.model.AtomItem", dojox.atom.io.model.Node, {constructor:function (args) {
	...
	dojo.declare("dojox.atom.io.model.Category", dojox.atom.io.model.Node, {constructor:function (scheme, term, label) {
		this.scheme = scheme;
		this.term = term;
		this.label = label;
	...
	dojo.declare("dojox.atom.io.model.Content", dojox.atom.io.model.Node, {constructor:function (tagName, value, src, type, xmlLang) {
	...
	dojo.declare("dojox.atom.io.model.Link", dojox.atom.io.model.Node, {constructor:function (href, rel, hrefLang, title, type) {
		this.href = href;
	...
	dojo.declare("dojox.atom.io.model.Person", dojox.atom.io.model.Node, {constructor:function (personType, name, email, uri) {
		this.author = "author";
	...
	dojo.declare("dojox.atom.io.model.Generator", dojox.atom.io.model.Node, {constructor:function (uri, version, value) {
		this.uri = uri;
	...
	dojo.declare("dojox.atom.io.model.Service", dojox.atom.io.model.AtomItem, {constructor:function (href) {
		this.href = href;
	}, buildFromDom:function (node) {
		var i;
		this.workspaces = [];
		...
		if (node.namespaceURI != dojox.atom.io.model._Constants.PURL_NS && node.namespaceURI != dojox.atom.io.model._Constants.APP_NS) {
			return;
		}
	...
	dojo.declare("dojox.atom.io.model.Workspace", dojox.atom.io.model.AtomItem, {constructor:function (title) {
		this.title = title;
		this.collections = [];
	}, buildFromDom:function (node) {
		...
		for (var i = 0; i < c.length; i++) {
			...
			if (child.nodeType === 1) {
				...
				if (child.namespaceURI == dojox.atom.io.model._Constants.PURL_NS || child.namespaceURI == dojox.atom.io.model._Constants.APP_NS) {
					...
					if (child.namespaceURI === dojox.atom.io.model._Constants.ATOM_NS) {
						if (name === "title") {
	...
	dojo.declare("dojox.atom.io.model.Collection", dojox.atom.io.model.AtomItem, {constructor:function (href, title) {
		this.href = href;
		this.title = title;
		this.attributes = [];
		this.features = [];
