...
if (!dojo._hasResource["dojox.charting.action2d.Base"]) {
	...
	(function () {
		var DEFAULT_DURATION = 400, DEFAULT_EASING = dojo.fx.easing.backOut, df = dojox.lang.functional;
		dojo.declare("dojox.charting.action2d.Base", null, {overOutEvents:{onmouseover:1, onmouseout:1}, constructor:function (chart, plot, kwargs) {
			this.chart = chart;
