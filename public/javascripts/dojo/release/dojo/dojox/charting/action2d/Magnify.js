...
if (!dojo._hasResource["dojox.charting.action2d.Magnify"]) {
	...
	(function () {
		var DEFAULT_SCALE = 2, m = dojox.gfx.matrix, gf = dojox.gfx.fx;
		dojo.declare("dojox.charting.action2d.Magnify", dojox.charting.action2d.Base, {defaultParams:{duration:400, easing:dojo.fx.easing.backOut, scale:DEFAULT_SCALE}, optionalParams:{}, constructor:function (chart, plot, kwArgs) {
