...
if (!dojo._hasResource["dojox.editor.plugins.Breadcrumb"]) {
	...
	dojo.declare("dojox.editor.plugins.Breadcrumb", dijit._editor._Plugin, {_menu:null, breadcrumbBar:null, setEditor:function (editor) {
		this.editor = editor;
		this._buttons = [];
		...
		if (ed.window) {
			...
			if (sel && sel.rangeCount > 0) {
				...
				var node = dojo.withGlobal(ed.window, "getSelectedElement", dijit._editor.selection) || range.startContainer;
				var bcList = [];
