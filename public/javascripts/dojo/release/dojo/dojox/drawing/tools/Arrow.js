...
if (!dojo._hasResource["dojox.drawing.tools.Arrow"]) {
	...
	dojox.drawing.tools.Arrow = dojox.drawing.util.oo.declare(dojox.drawing.tools.Line, function (options) {
		if (this.arrowStart) {
	...
	}, {draws:true, type:"dojox.drawing.tools.Arrow", baseRender:false, arrowStart:false, arrowEnd:true, onUp:function (obj) {
