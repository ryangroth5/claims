...
if (!dojo._hasResource["dojox.drawing.manager.Anchors"]) {
	...
	dojox.drawing.manager.Anchors = dojox.drawing.util.oo.declare(function (options) {
	...
	dojox.drawing.manager.Anchor = dojox.drawing.util.oo.declare(function (options) {
		...
		if (this.selected) {
			...
			var orgx = pmx.dx + this.org.x, orgy = pmx.dy + this.org.y, x = obj.x - orgx;
			y = obj.y - orgy;
