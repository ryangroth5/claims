...
if (!dojo._hasResource["dojox.drawing.ui.Tooltip"]) {
	...
	(function () {
		var master = null;
		var MasterC = dojox.drawing.util.oo.declare(dojox.drawing.plugins._Plugin, function (options) {
			this.createDom();
		...
		dojox.drawing.ui.Tooltip = dojox.drawing.util.oo.declare(dojox.drawing.plugins._Plugin, function (options) {
			if (!master) {
