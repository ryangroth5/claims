...
if (!dojo._hasResource["dojox.data.AppStore"]) {
	...
	dojo.declare("dojox.data.AppStore", null, {url:"", urlPreventCache:false, xmethod:false, _atomIO:null, _feed:null, _requests:null, _processing:null, _updates:null, _adds:null, _deletes:null, constructor:function (args) {
		if (args && args.url) {
			this.url = args.url;
		}
