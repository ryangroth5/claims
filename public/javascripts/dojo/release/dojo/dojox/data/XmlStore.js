...
if (!dojo._hasResource["dojox.data.XmlStore"]) {
	...
	dojo.declare("dojox.data.XmlStore", null, {constructor:function (args) {
		...
		return declaration + dojox.xml.parser.innerXML(element);
		...
		try {
			...
			return new dojox.data.XmlItem(element, this, q);
		}
		catch (e) {
			console.log(e);
		}
	...
	dojo.declare("dojox.data.XmlItem", null, {constructor:function (element, store, query) {
