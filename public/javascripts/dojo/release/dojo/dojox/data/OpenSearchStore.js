...
if (!dojo._hasResource["dojox.data.OpenSearchStore"]) {
	...
	dojo.declare("dojox.data.OpenSearchStore", null, {constructor:function (args) {
		if (args) {
		...
		var def = dojo.xhrGet({url:this.url, handleAs:"xml", sync:true, preventCache:this.urlPreventCache});
