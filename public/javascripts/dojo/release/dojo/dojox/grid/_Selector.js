...
if (!dojo._hasResource["dojox.grid._Selector"]) {
	...
	(function () {
		...
		}, dojox.grid._ContentBuilder.prototype, {generateHtml:function (inDataIndex, inRowIndex) {
			var w = this.view.contentWidth || 0;
		...
		}, dojox.grid._SelectorContentBuilder.prototype, {getCellContent:function (rowIndex) {
			var v = this.view;
