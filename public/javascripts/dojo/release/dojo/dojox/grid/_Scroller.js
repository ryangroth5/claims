...
if (!dojo._hasResource["dojox.grid._Scroller"]) {
	...
	(function () {
		...
		dojo.declare("dojox.grid._Scroller", null, {constructor:function (inContentNodes) {
			...
			if (this.grid.rowHeight) {
				...
				return ((inPageIndex + 1) * this.rowsPerPage > this.rowCount ? this.rowCount - inPageIndex * this.rowsPerPage : this.rowsPerPage) * height;
			}
