...
if (!dojo._hasResource["dojox.date.timezone"]) {
	...
	(function (_d) {
		...
		var _loadedRanges = {};
		var _rules = {};
		var timezoneFileBasePath = cfg.timezoneFileBasePath || _d.moduleUrl("dojox.date", "zoneinfo");
		var loadingScheme = cfg.timezoneLoadingScheme || "preloadAll";
		var defaultZoneFile = cfg.defaultZoneFile || ((loadingScheme == "preloadAll") ? _zoneFiles : "northamerica");
		...
		function loadZoneFile(fileName) {
			...
			_d.xhrGet({url:timezoneFileBasePath + "/" + fileName, sync:true, handleAs:"olson-zoneinfo", load:loadZoneObj, error:errorLoadingZoneFile});
		}
		...
		var abbrExceptions = {"US":"S", "Chatham":"S", "NZ":"S", "NT_YK":"S", "Edm":"S", "Salv":"S", "Canada":"S", "StJohns":"S", "TC":"S", "Guat":"S", "Mexico":"S", "Haiti":"S", "Barb":"S", "Belize":"S", "CR":"S", "Moncton":"S", "Swift":"S", "Hond":"S", "Thule":"S", "NZAQ":"S", "Zion":"S", "ROK":"S", "PRC":"S", "Taiwan":"S", "Ghana":"GMT", "SL":"WAT", "Chicago":"S", "Detroit":"S", "Vanc":"S", "Denver":"S", "Halifax":"S", "Cuba":"S", "Indianapolis":"S", "Starke":"S", "Marengo":"S", "Pike":"S", "Perry":"S", "Vincennes":"S", "Pulaski":"S", "Louisville":"S", "CA":"S", "Nic":"S", "Menominee":"S", "Mont":"S", "Bahamas":"S", "NYC":"S", "Regina":"S", "Resolute":"ES", "DR":"S", "Toronto":"S", "Winn":"S"};
					...
					if (rl.r[5].indexOf("u") < 0 && rl.r[5].indexOf("s") < 0) {
						if (j === 0 && i > 0) {
							if (prevRules.length) {
								...
								if (_d.date.compare(new Date(prevRange[1]), rl.d, "date") === 0) {
		...
		_d.setObject("dojox.date.timezone", {getTzInfo:function (dt, tz) {
