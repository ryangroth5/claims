...
if (!dojo._hasResource["dojo._firebug.firebug"]) {
	...
	(function () {
		...
		if (!dojo.isFF && (!dojo.isChrome || dojo.isChrome < 3) && (!dojo.isSafari || dojo.isSafari < 4) && !isNewIE && !window.firebug && (typeof console != "undefined" && !console.firebug) && !dojo.config.useCustomLogger && !dojo.isAIR) {
			try {
