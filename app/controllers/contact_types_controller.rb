  ...
  def create
    ...
    respond_to do |format|
      if @contact_type.save
        format.html { redirect_to(@contact_type, :notice => 'ContactType was successfully created.') }
  ...
  def update
    ...
    respond_to do |format|
      if @contact_type.update_attributes(params[:contact_type])
        format.html { redirect_to(@contact_type, :notice => 'ContactType was successfully updated.') }
        format.xml  { head :ok }
      else
